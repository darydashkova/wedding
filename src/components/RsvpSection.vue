...
<template>
  <div class="section-card rsvp-layout illustrated-card rsvp-illustrated">
    ...
    <div>
      ...
      <p class="rsvp-copy">
        Если у вас есть особенности по меню или важные детали по размещению, оставьте комментарий в форме.
      </p>
      <div class="gift-note">
        <p class="gift-note-title">Небольшое пожелание</p>
        <p>
          Пожалуйста, не дарите нам цветы. Если захотите сделать приятный жест, будем рады бутылке хорошего вина,
          которую с удовольствием откроем в один из наших семейных вечеров.
        </p>
      </div>
    </div>
    ...
    <form class="rsvp-form" @submit.prevent="handleSubmit" novalidate>
      ...
      <label>
        ...
        <textarea
          ...
          rows="4"
          placeholder="Напишите, если нужен трансфер, есть вопросы по меню или другие детали"
        ></textarea>
      </label>
      ...
      <p class="form-note">
        Ответ будет отправлен на chernyavskiilev@yandex.ru. После первой тестовой заявки FormSubmit попросит подтвердить этот адрес по email.
      </p>
