...
const wedding = {
  ...
  place: {
    ...
    mapEmbedUrl:
      'https://yandex.ru/map-widget/v1/?ll=39.022187%2C45.058975&z=17&pt=39.022187,45.058975,pm2rdm',
    mapUrl: 'https://yandex.ru/maps/?ll=39.022187%2C45.058975&z=17&pt=39.022187,45.058975,pm2rdm',
  },
  timeline: [
    {
      time: '17:00',
    ...
    },
    {
      time: '18:30',
      title: 'Банкет',
      text: '1 Мая, 131, Краснодар. Именно здесь мы отметим наш незабываемый день.',
    },
  ],
